...
One-time parsing and bulk-loading of Google Takeout exports — the Fitbit
("Google Health") export and, optionally, a Google Fit export carrying
legacy device data (Basis Peak). Implemented in `backfill/`
(`python -m backfill`); full history loaded and verified on `warehouse-db`
2026-07-11. Format details: `docs/takeout-format.md`.
